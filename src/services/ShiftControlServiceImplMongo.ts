...
import {CrewShiftModel} from "../model/EmployeeMongooseModel.js";
import {HttpError} from "../errorHandler/HttpError.js";
import {generateShiftId} from "../utils/tools.js"
import {startShift} from "../controllers/shiftControlController.js";
...
export class ShiftControlServiceImplMongo implements ShiftControlService {
    ...
    async startShift(table_num: string): Promise<Shift> {
        ...
        if (lastShift && lastShift.finishShift === null) throw new HttpError(409, "Forbidden to start shift");
        ...
        return {table_num, time: newShift.startShift} as Shift;
    }
    ...
    async finishShift(table_num: string): Promise<Shift> {
        ...
        return {table_num, time: lastShift.finishShift} as Shift;
    }
